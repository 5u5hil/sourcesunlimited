...
<div class="container">
    ...
    <section id="primary" class="content-full-width">
        ...
        <div class="woocommerce">
             ...
             <a href="https://www.linkedin.com/uas/oauth2/authorization?response_type=code&amp;client_id=75fcybemoqsci1&amp;redirect_uri=http://ivycamp.in/verified-corporate-signup/&amp;state=987654321&amp;scope=r_basicprofile%20r_emailaddress%20w_share"><img src="<?= get_template_directory_uri(); ?>/images/Sign-In-Small.png" alt="Linkedin" style="  width: 150px;"/> </a>
...
$fields = array(
    ...
    'redirect_uri' => urlencode('http://ivycamp.in/verified-corporate-signup/'),
...
?>
            <!-- **checkout - Starts** -->                       
            <form name="checkout" method="post" class="checkout" action="/verified-corporate-save/" >
                <!-- **col2-set - Starts** -->                    
...
<!--                            <input type="submit"  name="submit" id="submit-corporate" value="Submit" data-value="Submit" />    
                 ...
                 <p class="form-row form-row-wide " >  
                                ...
                                <input type="text" class="input-text " name="ceo_name" id="ceo_name" placeholder=""   value="<?php if(isset($value['firstName'])) echo $value['firstName'] . " " . $value['lastName']; else echo ""; ?>" required="" >   </p>
                            <p class="form-row form-row-wide" >  
