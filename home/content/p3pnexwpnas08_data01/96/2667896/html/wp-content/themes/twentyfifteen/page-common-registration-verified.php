    ...
    if ($_POST['investor_type']) {
      ...
      // if ($_POST['investor_type'] == 'Individual') {
            ...
            if ($_POST['secrole']) {
                ...
                header("location:/verified-" . $_POST['role'] . "-signup/" . $extraInfo . "" . $secrole);
            } else {
                header("location:/verified-" . $_POST['role'] . "-signup/$extraInfo");
            }
...
<div class="full-width-section parallax full-section-bg" style="background-position: 50% 45px;">
    ...
    <div class="container">
        ...
        <div class="form-wrapper login" style="width:55%;">
            ...
            <form method="post" id="loginform" action="/common-registration-verified/" name="frmLogin">
