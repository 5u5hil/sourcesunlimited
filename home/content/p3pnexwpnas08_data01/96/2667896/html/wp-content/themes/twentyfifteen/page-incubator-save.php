...
update_post_meta($post_id, 'Institute Name', implode(',',$institute_array), true);
        ...
        update_post_meta($post_id, 'Contact Person Name', $_POST['contact_name'], true);
        ...
        update_post_meta($post_id, 'tools provided', implode(',',$tools_array), true);
...
Within the next 48 hours, IvyCamp will schedule a brief phone discussion with you (at your convenience) to understand your entrepreneurship and innovation related goals and how IvyCamp may help you meet them.
<br><br> After the discussion, you will be provided with a link to activate your membership. 
<br><br>    Thank You<br>
