<?php
// $args = array('posts_per_page' => -1, 'offset' => 0, 'post_type' => 'innovator');
...
if (is_user_logged_in()) {
    ...
    <div class="container">
        ...
        <section id="secondary-left" class="secondary-sidebar secondary-has-left-sidebar">
            <aside class="widget widget_product_categories">
                <ul>
                    <li> <a href="/innovator-dashboard/" class="active_menu">Dashboard</a> </li>
                    ...
                    <li> <a href="/edit-innovator/">Edit Profile</a> </li>
                </ul>	
            </aside>	
        ...
        <section id="primary" class="with-left-sidebar page-with-sidebar">
            ...
            $args = array('offset' => 0, 'post_type' => 'innovator', 'author' => $current_user->ID);
    ...
    <?php endwhile; ?>
                            ...
                            <div class="portfolio dt-sc-one-fourth column with-space all-sort revenue institute-name industry">
                                ...
                                <div class="portfolio-detail" onclick="window.location.href = '<?= the_permalink(); ?>?id=post_details'">
                                    ...
                                    <div class="portfolio-title">
                                        ...
                                        <strong><?php if (get_post_meta(get_the_ID(), 'Independant or Associated', true) == 'Associated') {
                                            echo "Associated With: ";
                                        } else {
                                            echo "Independent Incubator";
                                        }
                                        ?></strong><br/>
                                        <p><?php if (get_post_meta(get_the_ID(), 'Independant or Associated', true) == 'Associated') {
            ...
            <div class="portfolio-container products">
                        ...
                        <?php
                        $investor = array('posts_per_page' => 6, 'offset' => 0, 'post_type' => 'investor');
                ...
                <?php foreach (explode(",", get_post_meta(get_the_ID(), 'Alumni', true)) as $idd) { ?>
                                            <p><?= get_the_category_by_ID($idd); ?></p>
                <?php } ?>
                                        <strong>Sectors:</strong><br/>
                <?php foreach (explode(",", get_post_meta(get_the_ID(), 'Sector', true)) as $sector) { ?>
                                            <p><?php echo get_the_category_by_ID($sector); ?></p>
                <?php } ?>
                                    </div>

                                </div><!-- **portfolio-detail - Ends** --><!-- **portfolio-detail - Ends** -->
            ...
            <div class="portfolio-container products">
                        ...
                        <?php
                        $mentor = array('posts_per_page' => 6, 'offset' => 0, 'post_type' => 'mentor');
            ...
            <div class="portfolio-container">
                        ...
                        <?php
                        $corporate = array('posts_per_page' => 6, 'offset' => 0, 'post_type' => 'corporate');
                ...
                ?>
                                ...
                                <div class="portfolio-detail" onclick="window.location.href = '<?= the_permalink(); ?>?id=post_details'">
                                    ...
                                    <<div class="views">
                                        ...
                                        <span>Sector -<?php if(get_post_meta(get_the_ID(), 'Sector of interest', true)) { foreach (explode(",", get_post_meta(get_the_ID(), 'Sector of interest', true)) as $sector) { ?>
                    <?php echo get_the_category_by_ID($sector); ?>
                                        <?php } } else { echo "Not Avail."; } ?> </span>
                                    </div>
                                    ...
                                    <div class="portfolio-title">
                                        ...
                                        <p>City of Location - <?php if(get_post_meta(get_the_ID(), 'City Of location', true)) { echo  get_the_category_by_ID(get_post_meta(get_the_ID(), 'City Of location', true)); } else { echo "Not Avail."; }?></p>
            ...
            <div class="portfolio-container">
                        ...
                        <?php
                        $institute = array('posts_per_page' => 6, 'offset' => 0, 'post_type' => 'institute');
                ...
                ?>
                                ...
                                <div class="portfolio-detail" onclick="window.location.href = '<?= the_permalink(); ?>?id=post_details'">
                                    ...
                                    <div class="views">
                                        <h5 class="prname"><a href="<?= the_permalink(); ?>?id=post_details">"><?php if(get_post_meta(get_the_ID(), 'Alumni of Institute', true)) { get_the_category_by_ID(get_post_meta(get_the_ID(), 'Alumni of Institute', true)); } else { echo "Not Avail."; } ?></a></h5>
                                        <span>City of Location -<?php if(get_post_meta(get_the_ID(), 'City Of location', true)) { echo  get_the_category_by_ID(get_post_meta(get_the_ID(), 'City Of location', true)); } else { echo "Not Avail."; }?> </span>
                                    </div>
                                    ...
                                    <!--                            <div class="portfolio-title">
                                                                    ...
                                                                    <p>Position at institute - <?php // get_the_category_by_ID(get_post_meta(get_the_ID(), 'Position', true));  ?></p>
