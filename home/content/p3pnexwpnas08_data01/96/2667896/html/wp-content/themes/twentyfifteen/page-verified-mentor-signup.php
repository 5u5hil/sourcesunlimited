...
<div class="container">
    ...
    <section id="primary" class="content-full-width">
        ...
        <div class="woocommerce">
            ...
            <a href="https://www.linkedin.com/uas/oauth2/authorization?response_type=code&amp;client_id=75fcybemoqsci1&amp;redirect_uri=http://ivycamp.in/verified-mentor-signup/&amp;state=987654321&amp;scope=r_basicprofile%20r_emailaddress%20w_share"><img src="<?= get_template_directory_uri(); ?>/images/Sign-In-Small.png" alt="Linkedin" style="  width: 150px;"/> </a>
            ...
            $fields = array(
                ...
                'redirect_uri' => urlencode('http://ivycamp.in/verified-mentor-signup/'),
...
//close connection
            ...
            <form name="checkout" method="post" class="checkout" action="/verified-mentor-save/" enctype="multipart/form-data">
                <!-- **col2-set - Starts** -->                                    
                    ...
                    <div class="col-1">
                        ...
                        <div class="woocommerce-billing-fields">
                            ...
                            <p class="form-row form-row-wide validate-phone" >    
                                ...
                                <input type="text" class="input-text " name="mobile" id="mobile"  placeholder=""  value=""  />                            </p>
