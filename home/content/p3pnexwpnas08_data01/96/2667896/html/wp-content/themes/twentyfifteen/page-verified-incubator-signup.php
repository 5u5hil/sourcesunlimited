        ...
        <div class="woocommerce">
            ...
            if ($_REQUEST['subtype'] == 'Individual') {
                ...
                if ($_REQUEST['secrole'] == 'mentor') {
                    ...
                    <a href="https://www.linkedin.com/uas/oauth2/authorization?response_type=code&amp;client_id=75fcybemoqsci1&amp;redirect_uri=http://ivycamp.cruxservers.in/verified-incubator-signup/?subtype=Individual&secrole=mentor&amp;state=987654321&amp;scope=r_basicprofile%20r_emailaddress%20w_share"><img src="<?= get_template_directory_uri(); ?>/images/Sign-In-Small.png" alt="Linkedin" style="  width: 150px;"/> </a>
                    <?php
                    $url = 'https://www.linkedin.com/uas/oauth2/accessToken';
                    $fields = array(
                        'grant_type' => urlencode('authorization_code'),
                        'code' => urlencode($_GET['code']),
                        'redirect_uri' => urlencode('http://ivycamp.cruxservers.in/verified-incubator-signup/?subtype=Individual&secrole=mentor'),
                        'client_id' => urlencode('75fcybemoqsci1'),
                        'client_secret' => urlencode('ABj1SfJUvTH8mCPx')
                    );
                } else {
                    ?>
                    <a href="https://www.linkedin.com/uas/oauth2/authorization?response_type=code&amp;client_id=75fcybemoqsci1&amp;redirect_uri=http://ivycamp.cruxservers.in/verified-incubator-signup/?subtype=Individual&amp;state=987654321&amp;scope=r_basicprofile%20r_emailaddress%20w_share"><img src="<?= get_template_directory_uri(); ?>/images/Sign-In-Small.png" alt="Linkedin" style="  width: 150px;"/> </a>
                    <?php
                    $url = 'https://www.linkedin.com/uas/oauth2/accessToken';
                    $fields = array(
                        'grant_type' => urlencode('authorization_code'),
                        'code' => urlencode($_GET['code']),
                        'redirect_uri' => urlencode('http://ivycamp.cruxservers.in/verified-incubator-signup/?subtype=Individual'),
                        'client_id' => urlencode('75fcybemoqsci1'),
                        'client_secret' => urlencode('ABj1SfJUvTH8mCPx')
                    );
                }
                ...
                ?>
                <a href="https://www.linkedin.com/uas/oauth2/authorization?response_type=code&amp;client_id=75fcybemoqsci1&amp;redirect_uri=http://ivycamp.cruxservers.in/verified-incubator-signup/&amp;state=987654321&amp;scope=r_basicprofile%20r_emailaddress%20w_share"><img src="<?= get_template_directory_uri(); ?>/images/Sign-In-Small.png" alt="Linkedin" style="  width: 150px;"/> </a>
                <?php
                $url = 'https://www.linkedin.com/uas/oauth2/accessToken';
                $fields = array(
                    'grant_type' => urlencode('authorization_code'),
                    'code' => urlencode($_GET['code']),
                    'redirect_uri' => urlencode('http://ivycamp.cruxservers.in/verified-incubator-signup/'),
                    'client_id' => urlencode('75fcybemoqsci1'),
                    'client_secret' => urlencode('ABj1SfJUvTH8mCPx')
                );
            }
...
//close connection
            ...
            ?>
            <form name="checkout" method="post" class="checkout" action="/verified-incubator-save/" enctype="multipart/form-data">
                ...
                <div class="col2-set" id="customer_details">
                    ...
                    <div class="col-1">
                        ...
                        <p class="form-row form-row-wide " >
                            ...
                            <input type="text" class="input-text " name="incubator_name" id="incubator_name" placeholder=""  value="<?php
                        ...
                        <div id="corporate_div" style="display:none">
                                <label> Corporate / Organization </label>
                                 <select  name="corporate_name" class="corporate_name"  id="corporate_name" >
                                     <option value="">---Select---</option>
                                            <?php $corpoarte = get_categories(array('parent' => 340, 'hide_empty' => 0)); ?>
                    ...
                    <div class="col-1">
                        ...
                        <p class="form-row form-row-wide " >
                            ...
                            <select name="incubatee_supported" id="incubatee_supported" >
                                ...
                                <?php $incubatee = get_categories(array('parent' => 323, 'hide_empty' => 0, 'order' => 'DESC')); ?>
                        ...
                        <p class="form-row form-row-wide" id="tooldiv" >
                            ...
                            <select  multiple="multiple" placeholder="-- Select --"  name="tools_provided[]" id="tools_provided" class="SlectBox" >
                                ...
                                <?php $tools = get_categories(array('parent' => 327, 'hide_empty' => 0, 'order' => 'DESC')); ?>
                ...
                <p class="form-row form-row-wide" id="servicediv" >
                        ...
                        <p class="form-row form-row-wide  " >
                            ...
                            <select name="funding_provided" id="funding_provided" >
                              ...
                              <?php $funding = get_categories(array('parent' => 333, 'hide_empty' => 0,  'orderby'=> 'ID','order' => 'ASC')); ?>
                                <?php foreach ($funding as $fundingval) { 
                                    if($fundingval->term_id == 335) { ?>
