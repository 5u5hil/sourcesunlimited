...
<div class="container">
    ...
    <section id="secondary-left" class="secondary-sidebar secondary-has-left-sidebar">
        <aside class="widget widget_product_categories">
            <ul>
                <li> <a href="/investor-dashboard/" class="active_menu">Dashboard</a> </li>
                <li> <a href="/startup-listing/">Startups</a> </li>
                <li> <a href="/innovator-listing/">Innovators</a> </li>
                <li> <a href="/edit-investor/">Edit Profile</a> </li>
    ...
    <section id="primary" class="with-left-sidebar page-with-sidebar">
        ...
        $args = array('offset' => 0, 'post_type' => 'investor', 'author' => $current_user->ID);
        ...
        // print_r($the_query);
         ...
         $iinstitute_id = get_post_meta(get_the_ID(), 'Alumni', true);
