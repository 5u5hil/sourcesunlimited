...
//$startup = array('posts_per_page' => 3, 'offset' => 0, 'post_type' => 'startup');
//
//
//            $the_query_startup = new WP_Query($startup);
//
////$the_query_mentor = new WP_Query($mentor);
//$post_mentor = $the_query_startup->post;
//echo $post_mentor_id = $post_mentor->ID;
//
//            if ($the_query_startup->have_posts()) : while ($the_query_startup->have_posts()) : $the_query_startup->the_post();
//                 
//            $sinstitute_id = get_post_meta($post_mentor_id, 'Institute Name', true);
...
<div class="container">
    ...
    <section id="secondary-left" class="secondary-sidebar secondary-has-left-sidebar">
        <aside class="widget widget_product_categories">
            <ul>
                <li> <a href="/mentor-dashboard/" class="active_menu" >Dashboard</a> </li>
                <li> <a href="/startup-listing/">Startups</a> </li>
                <li> <a href="/innovator-listing/">Innovators</a> </li>
                 <li> <a href="/edit-mentor/">Edit Profile</a> </li>
...
<?php 
  ...
  <?php 
   ...
   $current_user = wp_get_current_user();
    $args = array( 'offset' => 0 , 'post_type' => 'mentor', 'author' => $current_user->ID);
...
<?php } } else { echo "Not Avail.";} ?>
   ...
   <div class="bview"><a href="/startup-listing/" style="text-align: left;">View All</a></div> <div class="clear"></div>
 <!-- **Mentor ** --><hr/>
 <div class="clear"></div>
 <h3> Innovators </h3>
  <div class="clear"></div>
