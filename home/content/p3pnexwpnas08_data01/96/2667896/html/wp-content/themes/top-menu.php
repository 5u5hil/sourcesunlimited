        ...
        if ( is_user_logged_in() ) {
            ...
            echo '<ul class="top-header-menu td_ul_logout">
                        ...
                        <li class="menu-item">' .
                            ...
                            get_avatar($current_user->ID, 20) . '<a href="/dashboard" class="td_user_logd_in">' . $current_user->display_name . '</a><i class="td-icon-logout"></i>' .
            ...
            echo '
                ...
                <ul class="top-header-menu"><li class="menu-item"><a class="menu-item" href="/login" >' . __td("Sign in / Join") . $td_user_join . '</a><span class="td-sp-ico-login td_sp_login_ico_style"></span></li></ul>
                ...
                <div  id="login-form" class="white-popup-block mfp-hide mfp-with-anim">
                    ...
                    <div class="td-login-wrap">
                        ...
                        <div id="td-login-div" class="">
                            ...
                            <div class="td-login-panel-title">' . __td("Welcome! Log into your account") .'</div>
