...
// $ = jQuery;
	...
	//	$(this).closest('p.SlectBox').css( "display", "inline" ).fadeOut( 1000 )
		$( this ).next( "p" ).addClass( "asd" ).removeClass( "asd" );
		});
...
<div class="container">
    ...
    <section id="primary" class="content-full-width">
        ...
        <div class="woocommerce">
            ...
            <br/>
            <br/>
            <form name="checkout" method="post" class="checkout" action="/insert-page/" enctype="multipart/form-data">
                <!-- **col2-set - Starts** -->    
                    ...
                    <div class="col-1">
                        ...
                        <div class="woocommerce-billing-fields"> 
                            ...
                            <div class="form-row form-row-wide address-field ">
                                ...
                                <select name="address" id="address" class="country_to_state country_select address">
                ...
                <div class="col2-set" id="starup_details">
                    ...
                    <div class="col-2">
                        ...
                        <div class="woocommerce-shipping-fields">
                            ...
                            <div class="shipping_address">
                                <div class="form-row form-row-wide " id="prole">
                                ...
                                <div id="scheck">
                                    <div class="form-row form-row-first address-field validate-state"  id="stfield">
                                        <label> Year of Graduation  </label>
                                        <select name="graduation" id="graduation" class="graduation"   >
                                            <option value="">-- Select --</option>
                                    ...
                                    <div class="form-row form-row-last address-field validate-state" id="inst" >
                                ...
                                <!--  <div id="acheck">
                                      <div class="form-row form-row-wide address-field validate-state" >
                                          <label> Institute *  </label>
                                          <select multiple="multiple" placeholder ="-- Select --" name="institute_name[]"  class="institute_name SlectBox "  >
                                ...
                                <?php foreach ($Alumni as $Alumnival) { ?>
                                                          <option value="<?php echo $Alumnival->term_id ?>" ><?php echo $Alumnival->name ?></option>
                                <?php } ?>
                                              <option value="other">Other3</option>
                                          </select>
                                      </div>  
                                  </div>-->
                ...
                <div class="col2-set" id="starup_details">
                    ...
                    <div class="col-1">
                        ...
                        <div class="woocommerce-billing-fields"> 
                            ...
                            <p class="form-row form-row-wide " >
                                <label for="upload-logo" class="">Upload Logo (Max file upload size 2mb) </label>
                                <input type="file" class="input-text " name="logo" id="file" placeholder=""  value=""  /></p>

                           

                            <p class="form-row form-row-wide " >
                                <label for="business_plan" class="">Upload Business Plan (Max file upload size 2mb)</label>
...
//            
            ...
            if (service_pitch == '' || service_pitch == null || service_pitch.length > 400)
            {
            ...
            if (isp == '' || isp == null || isp.length > 400)
            {
            ...
            if (target_market == '' || target_market == null || target_market.length > 400)
            {
            ...
            if (linepitch == '' || linepitch == null || linepitch.length > 100)
            {
