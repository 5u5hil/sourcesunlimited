    ...
    <section id="primary" class="content-full-width">
        ...
        <div class="woocommerce">
            ...
            if (!$user_id && $_POST['email'] != "" && $_POST['password'] != "" && $_POST['corporation_name'] != "" && $postCats != "" ) {
                ...
                $userdata = array('user_login' => $_POST['email'],
                    'user_email' => $_POST['email'],
                    'corporation_name' => $_POST['corporation_name'], 
                    'first_name' => $_POST['corporation_name'],
                    'role' => 'contributor',
                    'user_pass' => $_POST['password']);
                $user_id = wp_insert_user($userdata);
                update_user_meta($user_id, 'entity', $_POST['entity']);
                $my_post = array('post_title' => $_POST['corporation_name'],
                    'post_status' => 'publish',
                    'post_type' => 'corporate', 
...
- There is an annual fee to register on IvyCamp as a corporate. This fee is being waived for you for the first 90 days and will be charged if you choose to continue participating as an investor on the IvyCamp platform 90 days after your registration date. For the first year, you will be charged a discounted rate of Rs. 3,00,000. 
<br>
