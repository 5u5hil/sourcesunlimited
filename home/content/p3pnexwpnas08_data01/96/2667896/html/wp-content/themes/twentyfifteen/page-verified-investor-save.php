        ...
        <div class="woocommerce">
            ...
            if (!$user_id && $_POST['email'] != "" && $_POST['password'] != "" && $_POST['investor_name']!="" && $postCats!="" ) {
                ...
                if ($post_id) {
                    ...
                    update_post_meta($post_id, 'Type of investor', $investor, true);
...
Welcome to the IvyCamp Platform. You have successfully registered. Please enjoy your 90 days of free access on the IvyCamp Platform. <br> <br>
...
<b><u>Additional Terms and Conditions</u></b><br><br>
90 days after registering, you will be charged a discounted annual fee of Rs. 30,000 for registering as an investor on the IvyCamp Platform. <br> 
<br> <br>
For any investment made in a startup/innovator on this platform, you will be charged an administrative fee of 1% of the amount of your investment.
