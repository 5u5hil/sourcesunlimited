                        ...
                        <div class="woocommerce-billing-fields"> 
                            ...
                            <!--                            <div class="form-row form-row-wide address-field"  id="sectordiv">	
                                                            <label for="sector" class="">Sectors *</label>
                                                                ...
                                                                <select  multiple="multiple"  name="sector[]"   required="" placeholder="-- Select --" class="SlectBox  "> 
                            ...
                            <div id="patent_id" style="display: none">

                                <input type="text" class="input-text" id="patent_number" value="" placeholder="Patent Number" name="patent_number"/></p>
                            </div>
...
<!--                            <p>   
                            ...
                            <div class="form-row form-row-wide address-field" id="inst" >
...
<script>
    ...
    $(document).ready(function () {
        ...
        $('#status_of_patent').on('change', function () {



            if ($(this).val() == 'patented')

            {

                $('#patent_id').show();

                $('#patent_number').prop('required', true);
...

            {
                ...
                $('#patent_number').prop('required', false);
...
//    alert("dgsdgsd");
        ...
        $('#innovator_signup').click(function () {
            ...
            var innovator_name = $('#innovation_name').val();
