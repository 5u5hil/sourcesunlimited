        ...
        <div class="woocommerce">
            ...
            if ($_REQUEST['subtype'] == 'Individual') {
                ...
                if ($_REQUEST['secrole'] == 'mentor') {
                    ...
                    <a href="https://www.linkedin.com/uas/oauth2/authorization?response_type=code&amp;client_id=75fcybemoqsci1&amp;redirect_uri=http://ivycamp.in/verified-investor-signup/?subtype=Individual&secrole=mentor&amp;state=987654321&amp;scope=r_basicprofile%20r_emailaddress%20w_share"><img src="<?= get_template_directory_uri(); ?>/images/Sign-In-Small.png" alt="Linkedin" style="  width: 150px;"/> </a>
                    <?php
                    $url = 'https://www.linkedin.com/uas/oauth2/accessToken';
                    $fields = array(
                        'grant_type' => urlencode('authorization_code'),
                        'code' => urlencode($_GET['code']),
                        'redirect_uri' => urlencode('http://ivycamp.in/verified-investor-signup/?subtype=Individual&secrole=mentor'),
                        'client_id' => urlencode('75fcybemoqsci1'),
                        'client_secret' => urlencode('ABj1SfJUvTH8mCPx')
                    );
                } else {
                    ?>
                    <a href="https://www.linkedin.com/uas/oauth2/authorization?response_type=code&amp;client_id=75fcybemoqsci1&amp;redirect_uri=http://ivycamp.in/verified-investor-signup/?subtype=Individual&amp;state=987654321&amp;scope=r_basicprofile%20r_emailaddress%20w_share"><img src="<?= get_template_directory_uri(); ?>/images/Sign-In-Small.png" alt="Linkedin" style="  width: 150px;"/> </a>
                    <?php
                    $url = 'https://www.linkedin.com/uas/oauth2/accessToken';
                    $fields = array(
                        'grant_type' => urlencode('authorization_code'),
                        'code' => urlencode($_GET['code']),
                        'redirect_uri' => urlencode('http://ivycamp.in/verified-investor-signup/?subtype=Individual'),
                        'client_id' => urlencode('75fcybemoqsci1'),
                        'client_secret' => urlencode('ABj1SfJUvTH8mCPx')
                    );
                }
                ...
                ?>
                <a href="https://www.linkedin.com/uas/oauth2/authorization?response_type=code&amp;client_id=75fcybemoqsci1&amp;redirect_uri=http://ivycamp.in/verified-investor-signup/&amp;state=987654321&amp;scope=r_basicprofile%20r_emailaddress%20w_share"><img src="<?= get_template_directory_uri(); ?>/images/Sign-In-Small.png" alt="Linkedin" style="  width: 150px;"/> </a>
                <?php
                $url = 'https://www.linkedin.com/uas/oauth2/accessToken';
                $fields = array(
                    'grant_type' => urlencode('authorization_code'),
                    'code' => urlencode($_GET['code']),
                    'redirect_uri' => urlencode('http://ivycamp.in/verified-investor-signup/'),
                    'client_id' => urlencode('75fcybemoqsci1'),
                    'client_secret' => urlencode('ABj1SfJUvTH8mCPx')
                );
            }
...
//close connection
            ...
            ?>
            <form name="checkout" method="post" class="checkout" action="/verified-investor-save/" enctype="multipart/form-data">
...
<?php } ?>
                    ...
                    <div class="col-1">	
                        ...
                        <div class="clear"></div>
                        <p class="form-row form-row-wide " >
                            <label for="upload-logo" class="">Upload Picture (Maximum file upload size 250kb) </label>
