...
<div class="container">
    ...
    <section id="secondary-left" class="secondary-sidebar secondary-has-left-sidebar">
        <aside class="widget widget_product_categories">
            <ul>
                <li> <a href="/corporate-dashboard/" class="active_menu">Dashboard</a> </li>
...
<?php 
   ...
   $current_user = wp_get_current_user();
    $args = array( 'offset' => 0 , 'post_type' => 'corporate', 'author' => $current_user->ID);
         ...
         $ask_question_id = $post->ID;
             $post = $the_query->post;
            $post_id = $post->ID;
            $cinstitute_id = get_post_meta($post_id, 'Institute Name', true);
            $ids = explode(',', $cinstitute_id);
...
<!--  
                    ...
                    <div class="column dt-sc-one-third first">
                        ...
                        <div class="dt-sc-donutchart-medium">
                            ...
                            <div class="dt-sc-donutchart" data-percent="12" data-fgcolor="#f1c40f" data-bgcolor="#ebeff0" data-size="160"> </div>
                          
                            <h6 class="dt-sc-donutchart-title"></h6>
                            <p></p>
                        </div>
                    ...
                    <div class="column dt-sc-one-third">
                        ...
                        <div class="dt-sc-donutchart-medium">
                            ...
                            <div class="dt-sc-donutchart" data-percent="25" data-fgcolor="#3498db" data-bgcolor="#ebeff0" data-size="160"> </div>
                    ...
                    <div class="column dt-sc-one-third ">
                        ...
                        <div class="dt-sc-donutchart-medum last">
                           
                            <div class="dt-sc-donutchart" data-percent="35" data-fgcolor="#e74c3c" data-bgcolor="#ebeff0" data-size="160"> </div>
...
<?php } } else { echo "Not Avail.";} ?>
   ...
   <a href="/startup-listing/" style="text-align: left;"><div class="bview">View All</div></a>
 <!-- **Mentor ** -->
 <div class="clear"></div>
 <h3> Innovators </h3>
  <div class="clear"></div>
...
<?php } } else { echo "Not Avail.";} ?>
  ...
  <a href="/innovator-listing/" style="text-align: left;"><div class="bview">View All</div></a>
        <!-- **product - Ends** -->
