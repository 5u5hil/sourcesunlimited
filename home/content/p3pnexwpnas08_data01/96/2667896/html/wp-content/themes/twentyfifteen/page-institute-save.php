        ...
        <div class="woocommerce">
            ...
            if (!$user_id &&  $postCats != "" && $_POST['email']!="" && $_POST['password']!="" && $_POST['institute_name']!="") {
                $userdata = array(
                    ...
                    'first_name' => get_the_category_by_ID($_POST['institute_name']),
                    'role' => 'contributor',
...
Within the next 48 hours, IvyCamp will schedule a brief phone discussion with you (at your convenience) to understand your entrepreneurship goals and how IvyCamp may help you meet them. After the discussion, you will be provided with a link to activate your membership. 
<br><br><br><br>
Thank You<br>
