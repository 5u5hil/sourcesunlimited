           ...
           $timezone = +5.50;
            ...
            <div class="column dt-sc-one-fourth first" >
                <div class="id_logo">
                 ...
                 <div class="btn-detail"> <a href="#askque" class="dt-sc-button btn">Ask Question</a> 
                </div>
                    <?php 
                     $current_user = wp_get_current_user();
              //  if(get_user_meta($current_user->ID, "entity", true)=='mentor') {
                     if(in_array($user_id, $userId)) {
                        //  echo "GASDGSDGS";
                    ?><div class="btn-detail"> <a  class="dt-sc-button btn disablebtn" >Value Added</a></div>
                     <?php } else {?>
            ...
            <div class="column dt-sc-three-fourth">
                ...
                <!--                <h3 class="mb10"> Mentor Name       </h3>-->
                <h4 class="id_title"><?php the_title(); ?></h4>
                <div class="column dt-sc-one-half first">
                    <p class="detail_info"> <i class="fa fa-rupee"></i> Area of Expertise:  <span class="fblock"><?php if(get_post_meta(get_the_ID(), 'Areas of expertise', true)) { echo get_the_category_by_ID(get_post_meta(get_the_ID(), 'Areas of expertise', true)); } else { echo "Not Avail."; }?></span> </p>

                </div>
                <div class="column dt-sc-one-half ">
                    <p class="detail_info"> <i class="fa fa-envelope"></i> Sector to Invest in: <?php if(get_post_meta(get_the_ID(), 'interest to mentor', true)){ foreach (explode(",", get_post_meta(get_the_ID(), 'interest to mentor', true)) as $sector) { ?>
                ...
                <div class="full-width dt-sc-margin80">
                    ...
                    <blockquote class="type2"> 
                        ...
                        <q>Alumni of Institution: 
                            ...
                            <?php if(get_post_meta(get_the_ID(), 'Alumni of Institute', true)) { foreach (explode(",", get_post_meta(get_the_ID(), 'Alumni of Institute', true)) as $institute) { ?>
                    ...
                    <!--                <h4 class="id_title"> Contact Details </h4>
                                    ...
                                    <div class="id_contact mb0">
                                        <p><span class="fa fa-envelope-o"> </span> Email:  <?= get_post_meta(get_the_ID(), 'Email', true); ?></p>
                    ...
                    <div class="id_contact " id="askque">
                        ...
                        <p class="ptb3"><span class="fa fa-map-marker">  </span>  City of Location: <?php if(get_post_meta(get_the_ID(), 'City Of location', true)) { echo  get_the_category_by_ID(get_post_meta(get_the_ID(), 'City Of location', true)); } else { echo "Not Avail";} ?> </p>
                    </div>
                    <br/>
